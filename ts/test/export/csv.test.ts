...
describe("exportCsv", () => {
  ...
  it("includes all fixed columns in header", () => {
    ...
    for (const col of [
      ...
      "status", "expected_amount", "expected_from", "expected_to",
      "expected_due_at", "reason", "overpaid_by", "is_late", "remaining_amount",
    ]) {
  ...
  it("includes expected_from, expected_to, expected_due_at in data row", () => {
    ...
    expect(values[cols.indexOf("expected_from")]).toBe("0x2222222222222222222222222222222222222222");
