...
describe("createExplorerClient", () => {
  ...
  it("fetches address metadata", async () => {
    ...
    expect(fetchSpy).toHaveBeenCalledWith("https://explore.tempo.xyz/api/address/metadata/0x5188");
  });
  ...
  it("uses custom baseUrl", async () => {
    ...
    expect(fetchSpy).toHaveBeenCalledWith("https://custom.api/v1/address/metadata/0x5188");
  });
