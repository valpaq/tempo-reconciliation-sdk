...
const memoA = encodeMemoV1({ type: 'invoice', issuerTag: tagA, ulid: '01MASW9NF6YW40J40H289H858P' })
const memoB = encodeMemoV1({ type: 'invoice', issuerTag: tagB, ulid: '01MASW9NF6YW40J40H289H999Z' })
...
for (const event of events) {
  ...
  console.log(`  ${app} event -> status: ${result.status}${result.reason ? ` (${result.reason})` : ''}`)
}
